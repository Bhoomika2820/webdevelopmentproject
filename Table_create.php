<?php
	...
	$sql = "CREATE TABLE advertise_committee (committee VARCHAR(10) NOT NULL, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, event_category VARCHAR(100) NOT NULL, event_name VARCHAR(100) NOT NULL, caption VARCHAR(100) NOT NULL, event_desc VARCHAR(200) NOT NULL, host VARCHAR(50) NOT NULL, contact_name VARCHAR(50) NOT NULL, contact_num INT NOT NULL, reg_link VARCHAR(500) NOT NULL, image LONGBLOB NOT NULL)";
